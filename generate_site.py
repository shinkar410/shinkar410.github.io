...
PAGES = {
    ...
    "משקפי-ראייה-הפוכה": "משקפי ראייה הפוכה — חדר כושר למוח",
    "גלריה": "גלריה",
    "סרטונים": "סרטונים",
    "אודותינו": "אודותינו",
    "צור-קשר": "צור קשר",
...
def build_home():
    ...
    NEW_BLURBS = {
        ...
        "משקפי-ראייה-הפוכה": "חדר כושר למוח (לא VR!) — משקפיים שמהפכים את הראייה: משימות שיווי משקל, מיקוד וצחוק גדול לכל המשפחה.",
    }
    covered = set()
    for c in cards:
    ...
    spots = [
        ...
        {"kick": "לחתונה שלכם", "title": "בובות ענק של חתן וכלה — רגע WOW בחתונה",
         "text": "החתן והכלה כבובות ענק: צילומים בלתי נשכחים, ריקודים עם האורחים ואפשרות למיתוג שמות החתן והכלה.",
